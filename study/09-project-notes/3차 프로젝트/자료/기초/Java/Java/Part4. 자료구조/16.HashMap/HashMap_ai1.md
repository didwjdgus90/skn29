...
Java에서 HashMap을 이해하면 코딩 테스트에서 자주 나오는 데이터 처리와 코드 구조를 더 깔끔하게 작성할 수 있다.

---

## 2. 어떤 문제를 해결하기 위해 사용하는가?

이름별 점수 저장, 빈도수 계산, 빠른 조회할 때 HashMap이 필요하다.
...
HashMap을 사용하면 이런 작업을 더 명확하고 안정적으로 표현할 수 있다.
...
위 코드는 HashMap의 가장 기본적인 사용 형태이다.
...
HashMap은 Java 기초에서 자주 사용되는 중요한 주제이다.
