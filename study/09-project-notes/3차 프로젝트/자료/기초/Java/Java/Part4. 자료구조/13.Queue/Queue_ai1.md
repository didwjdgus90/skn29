...
Java에서 Queue을 이해하면 코딩 테스트에서 자주 나오는 데이터 처리와 코드 구조를 더 깔끔하게 작성할 수 있다.

---

## 2. 어떤 문제를 해결하기 위해 사용하는가?

대기열, BFS, 순서대로 처리하는 작업할 때 Queue이 필요하다.
...
Queue을 사용하면 이런 작업을 더 명확하고 안정적으로 표현할 수 있다.
...
Queue은 Java 기초에서 자주 사용되는 중요한 주제이다.
