...
Java에서 ArrayList을 이해하면 코딩 테스트에서 자주 나오는 데이터 처리와 코드 구조를 더 깔끔하게 작성할 수 있다.

---

## 2. 어떤 문제를 해결하기 위해 사용하는가?

몇 개의 값이 들어올지 모를 때 순서대로 데이터를 저장할 때 ArrayList이 필요하다.
...
ArrayList을 사용하면 이런 작업을 더 명확하고 안정적으로 표현할 수 있다.

---

## 3. 핵심 아이디어

ArrayList의 핵심은 다음과 같다.
...
위 코드는 ArrayList의 가장 기본적인 사용 형태이다.
...
ArrayList은 Java 기초에서 자주 사용되는 중요한 주제이다.
