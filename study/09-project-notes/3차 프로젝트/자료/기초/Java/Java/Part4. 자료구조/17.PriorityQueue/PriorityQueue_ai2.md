...
쉽게 말해 PriorityQueue은 급한 사람을 먼저 처리하는 응급실 대기열라고 생각하면 된다.
...
최솟값 반복 추출, 작업 우선순위 처리, 다익스트라해야 할 때 PriorityQueue을 사용하면 코드가 훨씬 이해하기 쉬워진다.

---

## 3. 핵심 아이디어

PriorityQueue은 급한 사람을 먼저 처리하는 응급실 대기열이다.
...
예를 들어 PriorityQueue을 사용할 때는 다음처럼 생각할 수 있다.
...
PriorityQueue을 사용하기 위한 준비 단계이다.
...
PriorityQueue은 급한 사람을 먼저 처리하는 응급실 대기열처럼 이해하면 쉽다.
