...
쉽게 말해 Queue은 먼저 줄 선 사람이 먼저 나가는 대기줄라고 생각하면 된다.
...
대기열, BFS, 순서대로 처리하는 작업해야 할 때 Queue을 사용하면 코드가 훨씬 이해하기 쉬워진다.

---

## 3. 핵심 아이디어

Queue은 먼저 줄 선 사람이 먼저 나가는 대기줄이다.
...
예를 들어 Queue을 사용할 때는 다음처럼 생각할 수 있다.
...
Queue은 먼저 줄 선 사람이 먼저 나가는 대기줄처럼 이해하면 쉽다.
