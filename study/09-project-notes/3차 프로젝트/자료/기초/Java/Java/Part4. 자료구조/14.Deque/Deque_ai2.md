...
쉽게 말해 Deque은 앞문과 뒷문이 모두 있는 버스라고 생각하면 된다.
...
양방향 큐, 슬라이딩 윈도우, 앞뒤 처리가 모두 필요한 문제해야 할 때 Deque을 사용하면 코드가 훨씬 이해하기 쉬워진다.

---

## 3. 핵심 아이디어

Deque은 앞문과 뒷문이 모두 있는 버스이다.
...
예를 들어 Deque을 사용할 때는 다음처럼 생각할 수 있다.
...
Deque은 앞문과 뒷문이 모두 있는 버스처럼 이해하면 쉽다.
