...
쉽게 말해 Comparator은 줄을 세울 때 사용할 기준표라고 생각하면 된다.
...
점수순, 이름순, 길이순, 여러 조건 정렬해야 할 때 Comparator을 사용하면 코드가 훨씬 이해하기 쉬워진다.

---

## 3. 핵심 아이디어

Comparator은 줄을 세울 때 사용할 기준표이다.
...
예를 들어 Comparator을 사용할 때는 다음처럼 생각할 수 있다.
...
Comparator은 줄을 세울 때 사용할 기준표처럼 이해하면 쉽다.
