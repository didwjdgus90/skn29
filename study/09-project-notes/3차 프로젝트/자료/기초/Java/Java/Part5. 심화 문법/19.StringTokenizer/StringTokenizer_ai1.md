...
Java에서 StringTokenizer을 이해하면 코딩 테스트에서 자주 나오는 데이터 처리와 코드 구조를 더 깔끔하게 작성할 수 있다.

---

## 2. 어떤 문제를 해결하기 위해 사용하는가?

한 줄 입력에서 공백 기준으로 여러 값을 분리할 때 StringTokenizer이 필요하다.
...
StringTokenizer을 사용하면 이런 작업을 더 명확하고 안정적으로 표현할 수 있다.

---

## 3. 핵심 아이디어

StringTokenizer의 핵심은 다음과 같다.
...
위 코드는 StringTokenizer의 가장 기본적인 사용 형태이다.
...
StringTokenizer을 사용하기 위한 핵심 코드이다.
...
StringTokenizer은 Java 기초에서 자주 사용되는 중요한 주제이다.
