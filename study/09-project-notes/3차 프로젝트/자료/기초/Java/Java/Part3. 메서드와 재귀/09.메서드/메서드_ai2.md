...
쉽게 말해 메서드은 입력값을 받아 처리한 뒤 결과를 돌려주는 작은 기능 상자라고 생각하면 된다.
...
두 숫자를 더하는 기능을 여러 곳에서 재사용해야 할 때 메서드을 사용하면 코드가 훨씬 이해하기 쉬워진다.

---

## 3. 핵심 아이디어

메서드은 입력값을 받아 처리한 뒤 결과를 돌려주는 작은 기능 상자이다.
...
예를 들어 메서드을 사용할 때는 다음처럼 생각할 수 있다.
...
메서드은 입력값을 받아 처리한 뒤 결과를 돌려주는 작은 기능 상자처럼 이해하면 쉽다.
